...
public abstract class AbstractDisplay implements Display
{
     ...
     * the Actor facing North in a cell of size (1,1) centered around (0,0) on
     ...
     * drawing a unit-length Actor facing North. (Precondition: <code>obj</code>
     * is a Actor (or a Actor subclass).)
     * @param obj object we want to draw
     * @param comp component on which to draw
     * @param g2 drawing surface
